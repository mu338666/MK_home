...
<html lang="ko" dir="ltr">
  <head>
    ...
    <script type="text/javascript" src="./js/mk_list_member_form.js?ver=1"></script>
    <title></title>
  </head>
  <body>
    <div id="wrap">
      ...
      <div id="content">
       ...
       <div id="col2">
         ...
         <div class="clear"></div>
            ...
            <div id="write_button">
              <!--목록보기 -->
              <a href="./mk_list.php?page=<?=$page?>"><img src="./img/list.png"></a>

            <?php
              //세션값이 존재하면 수정기능과 삭제기능부여하기
              if(isset($_SESSION['userid'])){
                if($_SESSION['userid']=="admin" || $_SESSION['userid']==$id){
                  echo('<a href="mk_write_edit_form.php?mode=update&num='.$num.'"><img src="./img/modify.png"></a>&nbsp;');
                  echo('<img src="./img/delete.png" onclick="check_delete('.$num.')">&nbsp;');
                }
              }
              // 세션값이 존재하면 답변기능과 글쓰기 기능부여하기
              if(!empty($_SESSION['userid'])){
                echo '<a href="mk_write_edit_form.php?mode=response&num='.$num.'"><img src="./img/response.png"></a>';
