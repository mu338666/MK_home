...
<link rel="stylesheet" type="text/css" href="./mk_admin.css?ver=1">
</head>
<body>
<header>
...
?>
		...
		<li>
		<form method="post" action="mk_admin_member_update.php?num=<?=$num?>">
			...
			<span class="col8"><button type="button" onclick="location.href='mk_admin_member_delete.php?num=<?=$num?>'">삭제</button></span>
		</form>                                                <!--같은 폼속에서 다르게 보내고싶을때 -->
		</li>
...
?>
		...
		<form method="post" action="mk_admin_board_delete.php">
<?php
